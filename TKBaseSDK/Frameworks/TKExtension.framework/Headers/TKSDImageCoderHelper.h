 ...
 */
@interface TKSDImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<TKSDImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<TKSDImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
