...
/**
 ...
 Example:
     ...
     TKYYTextRunDelegate *delegate = [TKYYTextRunDelegate new];
     delegate.ascent = 20;
     delegate.descent = 4;
     delegate.width = 20;
 ...
 */
@interface TKYYTextRunDelegate : NSObject <NSCopying, NSCoding>

/**
 Creates and returns the CTRunDelegate.
 
 @discussion You need call CFRelease() after used.
 The CTRunDelegateRef has a strong reference to this TKYYTextRunDelegate object.
 In CoreText, use CTRunDelegateGetRefCon() to get this TKYYTextRunDelegate object.
