...
/**
 ...
 For a full GIF support, we recommend `TKSDAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface TKSDImageIOCoder : NSObject <TKSDProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) TKSDImageIOCoder *sharedCoder;
