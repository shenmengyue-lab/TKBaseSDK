...
/**
 A protocol to allow custom disk cache used in TKSDImageCache.
 */
@protocol TKSDDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull TKSDImageCacheConfig *)config;
 ...
 */
@interface TKSDDiskCache : NSObject <TKSDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) TKSDImageCacheConfig *config;
