...
typedef NSData * _Nullable(^TKSDWebImageCacheSerializerBlock)(UIImage * _Nonnull image, NSData * _Nullable data, NSURL * _Nullable imageURL);
 ...
 */
@protocol TKSDWebImageCacheSerializer <NSObject>
 ...
 */
@interface TKSDWebImageCacheSerializer : NSObject <TKSDWebImageCacheSerializer>

- (nonnull instancetype)initWithBlock:(nonnull TKSDWebImageCacheSerializerBlock)block;
+ (nonnull instancetype)cacheSerializerWithBlock:(nonnull TKSDWebImageCacheSerializerBlock)block;
