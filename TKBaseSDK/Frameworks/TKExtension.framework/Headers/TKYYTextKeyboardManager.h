...
/**
 ...
 Use -[TKYYTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} TKYYTextKeyboardTransition;


/**
 The TKYYTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol TKYYTextKeyboardObserver <NSObject>
@optional
- (void)keyboardChangedWithTransition:(TKYYTextKeyboardTransition)transition;
@end


/**
 A TKYYTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface TKYYTextKeyboardManager : NSObject
 ...
 */
- (void)addObserver:(id<TKYYTextKeyboardObserver>)observer;
 ...
 */
- (void)removeObserver:(id<TKYYTextKeyboardObserver>)observer;
