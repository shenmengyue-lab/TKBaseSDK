...
typedef NSString * _Nullable(^TKSDWebImageCacheKeyFilterBlock)(NSURL * _Nonnull url);
 ...
 */
@protocol TKSDWebImageCacheKeyFilter <NSObject>
 ...
 */
@interface TKSDWebImageCacheKeyFilter : NSObject <TKSDWebImageCacheKeyFilter>

- (nonnull instancetype)initWithBlock:(nonnull TKSDWebImageCacheKeyFilterBlock)block;
+ (nonnull instancetype)cacheKeyFilterWithBlock:(nonnull TKSDWebImageCacheKeyFilterBlock)block;
