...
#if __has_include(<TKMJRefresh/TKMJRefreshHeader.h>)
#import <TKMJRefresh/TKMJRefreshHeader.h>
#else
#import <TKExtension/TKMJRefreshHeader.h>

#endif

NS_ASSUME_NONNULL_BEGIN

@interface TKMJRefreshStateHeader : TKMJRefreshHeader
#pragma mark - 刷新时间相关
...
@interface TKMJRefreshStateHeader (ChainingGrammar)
