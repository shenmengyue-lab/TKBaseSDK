...
/**
 ...
 Coders
 ------
 A coder must conform to the `TKSDImageCoder` protocol or even to `SDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface TKSDImageCodersManager : NSObject <TKSDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) TKSDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<TKSDImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<TKSDImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<TKSDImageCoder>)coder;
