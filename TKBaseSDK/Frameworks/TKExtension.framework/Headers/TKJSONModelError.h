...
/////////////////////////////////////////////////////////////////////////////////////////////
typedef NS_ENUM(int, kTKJSONModelErrorTypes)
{
    kTKJSONModelErrorInvalidData = 1,
    kTKJSONModelErrorBadResponse = 2,
    kTKJSONModelErrorBadJSON = 3,
    kTKJSONModelErrorModelIsInvalid = 4,
    kTKJSONModelErrorNilInput = 5
};

/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the JSONModelError instances */
extern NSString *const TKJSONModelErrorDomain;
 ...
 */
extern NSString *const kTKJSONModelMissingKeys;
 ...
 */
extern NSString *const kTKJSONModelTypeMismatch;
 ...
 */
extern NSString *const kTKJSONModelKeyPath;
 ...
 */
@interface TKJSONModelError : NSError
