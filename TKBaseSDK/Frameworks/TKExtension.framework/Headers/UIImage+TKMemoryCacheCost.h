...
/**
 ...
 @note For custom animated class conforms to `TKSDAnimatedImage`, you can override this getter method in your subclass to return a more proper value instead, which representing the current frame's total bytes.
 */
