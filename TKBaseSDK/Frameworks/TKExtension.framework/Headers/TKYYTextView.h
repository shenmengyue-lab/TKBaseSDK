...
/**
 The TKYYTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for TKYYTextView objects. 
 ...
 */
@protocol TKYYTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(TKYYTextView *)textView;
- (BOOL)textViewShouldEndEditing:(TKYYTextView *)textView;
- (void)textViewDidBeginEditing:(TKYYTextView *)textView;
- (void)textViewDidEndEditing:(TKYYTextView *)textView;
- (BOOL)textView:(TKYYTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(TKYYTextView *)textView;
- (void)textViewDidChangeSelection:(TKYYTextView *)textView;

- (BOOL)textView:(TKYYTextView *)textView shouldTapHighlight:(TKYYTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TKYYTextView *)textView didTapHighlight:(TKYYTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(TKYYTextView *)textView shouldLongPressHighlight:(TKYYTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TKYYTextView *)textView didLongPressHighlight:(TKYYTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The TKYYTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+TKYYText.h for more convenience methods to set the attributes.
 See TKYYTextAttribute.h and TKYYTextLayout.h for more information.
 */
@interface TKYYTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<TKYYTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is TKYYTextVerticalAlignmentTop.
 */
@property (nonatomic) TKYYTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and TKYYTextAttribute.
 See `NSAttributedString+TKYYText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `TKYYTextParser` protocol for more information.
 */
@property (nullable, nonatomic, strong) id<TKYYTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) TKYYTextLayout *textLayout;
...
/**
 ...
 See `TKYYTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<TKYYTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [TKYYTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) TKYYTextDebugOption *debugOption;
...
@property (nonatomic) IBInspectable TKYYTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const TKYYTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const TKYYTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const TKYYTextViewTextDidEndEditingNotification;
