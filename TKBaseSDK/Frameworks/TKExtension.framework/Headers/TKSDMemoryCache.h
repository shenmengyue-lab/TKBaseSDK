...
@class TKSDImageCacheConfig;
/**
 A protocol to allow custom memory cache used in TKSDImageCache.
 */
@protocol TKSDMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull TKSDImageCacheConfig *)config;
 ...
 */
@interface TKSDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <TKSDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) TKSDImageCacheConfig *config;
