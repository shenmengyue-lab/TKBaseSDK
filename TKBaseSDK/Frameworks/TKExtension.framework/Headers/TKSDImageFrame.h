...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `TKSDImageCoderHelper`.
 @note If you need to specify animated images loop count, use `sd_imageLoopCount` property in `UIImage+TKMetadata.h`.
 */
@interface TKSDImageFrame : NSObject
