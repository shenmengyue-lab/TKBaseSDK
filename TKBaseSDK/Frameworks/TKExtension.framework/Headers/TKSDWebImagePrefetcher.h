...
@class TKSDWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface TKSDWebImagePrefetchToken : NSObject <TKSDWebImageOperation>
 ...
 */
@protocol TKSDWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull TKSDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull TKSDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;

@end

typedef void(^TKSDWebImagePrefetcherProgressBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfTotalUrls);
typedef void(^TKSDWebImagePrefetcherCompletionBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfSkippedUrls);

/**
 * Prefetch some URLs in the cache for future use. Images are downloaded in low priority.
 */
@interface TKSDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) TKSDWebImageManager *manager;
...
/**
 * The options for prefetcher. Defaults to TKSDWebImageLowPriority.
 */
@property (nonatomic, assign) TKSDWebImageOptions options;

/**
 * The context for prefetcher. Defaults to nil.
 */
@property (nonatomic, copy, nullable) TKSDWebImageContext *context;
 ...
 */
@property (weak, nonatomic, nullable) id <TKSDWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) TKSDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull TKSDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;

/**
 * Assign list of URLs to let TKSDWebImagePrefetcher to queue the prefetching. It based on the image manager so the image may from the cache and network according to the `options` property.
 ...
 */
- (nullable TKSDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
 ...
 */
- (nullable TKSDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls
                                          progress:(nullable TKSDWebImagePrefetcherProgressBlock)progressBlock
                                         completed:(nullable TKSDWebImagePrefetcherCompletionBlock)completionBlock;
