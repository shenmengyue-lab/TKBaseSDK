...
/**
 ...
 For the description about these methods, see `TKSDWebImageDownloaderOperation`
 ...
 */
@protocol TKSDWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
- (nullable id)addHandlersForProgress:(nullable TKSDWebImageDownloaderProgressBlock)progressBlock
...
/**
 The download operation class for TKSDWebImageDownloader.
 */
@interface TKSDWebImageDownloaderOperation : NSOperation <TKSDWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) TKSDWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) TKSDWebImageContext *context;

/**
 *  Initializes a `TKSDWebImageDownloaderOperation` object
 *
 *  @see TKSDWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(TKSDWebImageDownloaderOptions)options
                                context:(nullable TKSDWebImageContext *)context NS_DESIGNATED_INITIALIZER;
