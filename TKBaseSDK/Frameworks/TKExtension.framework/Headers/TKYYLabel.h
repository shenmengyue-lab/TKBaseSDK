...
/**
 The TKYYLabel class implements a read-only text view.
 ...
 */
@interface TKYYLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is TKYYTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) TKYYTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TKYYTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TKYYTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TKYYTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) TKYYTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `TKYYTextLayout` class in background thread. Here's an example:
    
    TKYYLabel *label = [TKYYLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        TKYYTextContainer *container = [TKYYTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        TKYYTextLayout *layout = [TKYYTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<TKYYTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) TKYYTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) TKYYTextAction textTapAction;
@property (nullable, nonatomic, copy) TKYYTextAction textLongPressAction;
@property (nullable, nonatomic, copy) TKYYTextAction highlightTapAction;
@property (nullable, nonatomic, copy) TKYYTextAction highlightLongPressAction;
