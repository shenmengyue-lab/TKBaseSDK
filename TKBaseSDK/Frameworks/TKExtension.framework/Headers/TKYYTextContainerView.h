...
/**
 A simple view to diaplay `TKYYTextLayout`.
 ...
 */
@interface TKYYTextContainerView : UIView
...
@property (nullable, nonatomic, strong) TKYYTextLayout *layout;
...
- (void)setLayout:(nullable TKYYTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;
