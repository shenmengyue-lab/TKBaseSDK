 ...
 */
@interface UIView (TKWebCacheOperation)
 ...
 */
- (nullable id<TKSDWebImageOperation>)sd_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)sd_setImageLoadOperation:(nullable id<TKSDWebImageOperation>)operation forKey:(nullable NSString *)key;
