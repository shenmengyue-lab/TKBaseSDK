...
#import <TKSDWebImage/UIImageView+TKWebCache.h>
...
/**
 * Integrates TKSDWebImage async downloading and caching of remote images with UIImageView.
 */
@interface UIImageView (TKWebCache)
