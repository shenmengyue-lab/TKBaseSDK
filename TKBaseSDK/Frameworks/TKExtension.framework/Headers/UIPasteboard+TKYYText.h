 ...
 */
@interface UIPasteboard (TKYYText)
...
UIKIT_EXTERN NSString *const TKYYTextPasteboardTypeAttributedString;

/// The UTI Type identifying WebP data in pasteboard.
UIKIT_EXTERN NSString *const TKYYTextUTTypeWEBP;
