...
/**
 The TKYYTextParser protocol declares the required method for TKYYTextView and TKYYLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 TKYYTextView and TKYYLabel. See `TKYYTextSimpleMarkdownParser` and `TKYYTextSimpleEmoticonParser` for example.
 */
@protocol TKYYTextParser <NSObject>
@required
/**
 When text is changed in TKYYTextView or TKYYLabel, this method will be called.
 ...
 no selected range (such as TKYYLabel), this value is NULL.
 ...
 */
@interface TKYYTextSimpleMarkdownParser : NSObject <TKYYTextParser>
 ...
 */
@interface TKYYTextSimpleEmoticonParser : NSObject <TKYYTextParser>
