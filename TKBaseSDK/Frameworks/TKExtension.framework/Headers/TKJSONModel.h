...
#import "TKJSONKeyMapper.h"
#import "TKJSONValueTransformer.h"
#import "TKJSONModelError.h"
...
/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - TKJSONModel protocol
/**
 ...
 */
@interface TKJSONModel : NSObject <AbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(TKJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(TKJSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(TKJSONModelError **)err;
